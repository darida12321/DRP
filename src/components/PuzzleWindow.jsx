...
function PuzzleWindow(props) {
  ...
  const barColor = completed ? cComplete : keypresses < moves ? cDefault : cError;
      ...
      <div id="textbox">
        <div id="content">
          ...
          <div id="keystroke-bar">
            <div id="keystroke-amount-bar" style={{ width: ratio * 100 + "%", background: barColor }}></div>
            <p>
              {Math.min(keypresses, moves)}/{moves} moves
            </p>
          </div>
        </div>
        <div id="solution-area">
          ...
          >
            ...
            <div
              id="arrow"
              style={{
                transform: solutionVisible
                  ? "translate(0, 0.2rem) rotate(-135deg)"
                  : "translate(0, -0.2rem) rotate(45deg)",
              }}
            ></div>
          </div>
          <div id="solution" style={{ visibility: solutionVisible ? "visible" : "hidden" }}>
